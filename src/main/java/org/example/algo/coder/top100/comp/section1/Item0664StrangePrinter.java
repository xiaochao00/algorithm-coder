...
public class Item0664StrangePrinter {
    public static void main(String[] args) {
        ...
        res = solution.strangePrinter2("aaabbb");
        System.out.println(res);
    }
    ...
    class Solution {
        ...
        public int strangePrinter2(String s) {
            ...
            if (leafList.size() > 1 && leafList.get(leafList.size() - 1).startsWith(s.substring(0, 1))) {
                count = count - 1;
            }
            return count;
        }
        ...
        public TreeNode buildTree(String s) {
            ...
            int size = cS.length();
            if (size <= 1 || stringHaveRedundancy(cS)) {
                root.s = cS;
                return root;
            }
